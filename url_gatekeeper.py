...
# Function to run the gatekeeper app
# This function is used to avoid admin rights issues with CTk root
# It creates a Toplevel window instead of a CTk root window.
# This allows the app to run without requiring admin privileges.
# It also ensures that the app can be run from other scripts or modules without issues.
# This is useful for testing or integrating the gatekeeper app into larger applications.
